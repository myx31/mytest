...
; 0000 0034 // Function: Bit7=In Bit6=In Bit5=In Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0035 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (1<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(16)
	OUT  0x11,R30
; 0000 0036 // State: Bit7=T Bit6=T Bit5=T Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0047 // OC1B output: Non-Inverted PWM
; 0000 0048 // Noise Canceler: Off
; 0000 0049 // Input Capture on Falling Edge
; 0000 004A // Timer Period: 1.024 s
; 0000 004B // Output Pulse(s):
; 0000 004C // OC1B Period: 1.024 s Width: 5.1206 ms
...
; 0000 0051 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (1<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(35)
	OUT  0x2F,R30
; 0000 0052 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (1<<WGM13) | (1<<WGM12) | (1<<CS12) | (0<<CS11) | (1<<CS10);
	LDI  R30,LOW(29)
	OUT  0x2E,R30
...
; 0000 0056 ICR1L=0x00;
	OUT  0x26,R30
; 0000 0057 OCR1AH=0x1F;
	LDI  R30,LOW(31)
	OUT  0x2B,R30
; 0000 0058 OCR1AL=0x3F;
	LDI  R30,LOW(63)
	OUT  0x2A,R30
; 0000 0059 OCR1BH=0x00;
	LDI  R30,LOW(0)
	OUT  0x29,R30
; 0000 005A OCR1BL=0x28;
	LDI  R30,LOW(40)
	OUT  0x28,R30
; 0000 005B 
