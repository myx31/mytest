...
; 0000 0027      if(start_stop==0)
	SBIC 0x19,2
	RJMP _0x4
; 0000 0028      {
; 0000 0029           delay_ms(20);
	RCALL SUBOPT_0x0
; 0000 002A           if(start_stop==0)
	SBIC 0x19,2
	RJMP _0x5
; 0000 002B           {
; 0000 002C                while(start_stop==0){}
_0x6:
	SBIS 0x19,2
	RJMP _0x6
; 0000 002D                ttdc=~ttdc;
	COM  R8
	COM  R9
; 0000 002E                if(ttdc==1) {captocdo=1;}
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	CP   R30,R8
	CPC  R31,R9
...
; 0000 0037      if(up==0)
	...
	RJMP _0xB
; 0000 0038      {
; 0000 0039           delay_ms(20);
	RCALL SUBOPT_0x0
; 0000 003A           if(up==0)
	SBIC 0x19,0
	RJMP _0xC
; 0000 003B           {
; 0000 003C           while(up==0)
_0xD:
	SBIC 0x19,0
	RJMP _0xF
; 0000 003D           captocdo++;
	...
	RJMP _0xD
_0xF:
; 0000 003E if(captocdo>10)
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	CP   R30,R6
	CPC  R31,R7
	BRSH _0x10
; 0000 003F           captocdo=10;
	MOVW R6,R30
; 0000 0040           }
_0x10:
; 0000 0041      }
...
; 0000 004D           captocdo--;
	...
	RJMP _0x13
_0x15:
; 0000 004E if(captocdo<1)
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	CP   R6,R30
	CPC  R7,R31
	BRSH _0x16
; 0000 004F           captocdo=1;
	MOVW R6,R30
; 0000 0050           }
_0x16:
; 0000 0051      }
...
_hiemthi:
; .FSTART _hiemthi
; 0000 0056      unsigned int temp;
; 0000 0057      //unsigned char a,b,c,d;
; 0000 0058      unsigned char m[4],i ;
; 0000 0059 
; 0000 005A   // tach so, luu vao 4 bien a b c d
; 0000 005B      temp=x;
	ST   -Y,R27
	ST   -Y,R26
	SBIW R28,4
...
_0x19:
; 0000 0061 
; 0000 0062      // dieu khien cho LED1 sang, hiem thi chu so a
; 0000 0063      PORTC.4 =0;
	CBI  0x15,4
; 0000 0064      PORTB = number[m[0]];
	LDD  R30,Y+4
	RCALL SUBOPT_0x1
; 0000 0065      delay_ms(1);
; 0000 0066      PORTC.4 =1;
	SBI  0x15,4
; 0000 0067      // dieu khien cho LED2 sang, hiem thi chu so b
; 0000 0068      PORTC.5 =0;
	CBI  0x15,5
; 0000 0069      PORTB = number[m[1]];
	LDD  R30,Y+5
	RCALL SUBOPT_0x1
; 0000 006A      delay_ms(1);
; 0000 006B      PORTC.5 =1;
	SBI  0x15,5
; 0000 006C      // dieu khien cho LED3 sang, hiem thi chu so c
; 0000 006D      PORTC.6 =0;
	CBI  0x15,6
; 0000 006E      PORTB = number[m[2]];
	LDD  R30,Y+6
	RCALL SUBOPT_0x1
; 0000 006F      delay_ms(1);
; 0000 0070      PORTC.6 =1;
	SBI  0x15,6
; 0000 0071      // dieu khien cho LED4 sang, hiem thi chu so d
; 0000 0072      PORTC.7 =0;
	CBI  0x15,7
; 0000 0073      PORTB = number[m[3]];
	LDD  R30,Y+7
	RCALL SUBOPT_0x1
...
; 0000 0090 DDRC=0xFF;
	LDI  R30,LOW(255)
	OUT  0x14,R30
; 0000 0091 PORTC=0x0F;
	LDI  R30,LOW(15)
	OUT  0x15,R30
; 0000 0092 // Port D initialization
; 0000 0093 // Function: Bit7=In Bit6=In Bit5=In Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0094 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (1<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(16)
	OUT  0x11,R30
; 0000 0095 // State: Bit7=T Bit6=T Bit5=T Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 009A // Clock value: 8000.000 kHz
; 0000 009B // Mode: Fast PWM top=0xFF
; 0000 009C // OC0 output: Disconnected
; 0000 009D // Timer Period: 0.032 ms
; 0000 009E TCCR0=(1<<WGM00) | (0<<COM01) | (0<<COM00) | (1<<WGM01) | (0<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(73)
	OUT  0x33,R30
...
; 0000 00A4 // Clock value: 8000.000 kHz
; 0000 00A5 // Mode: Fast PWM top=OCR1A
; 0000 00A6 // OC1A output: Disconnected
; 0000 00A7 // OC1B output: Non-Inverted PWM
; 0000 00A8 // Noise Canceler: Off
; 0000 00A9 // Input Capture on Falling Edge
; 0000 00AA // Timer Period: 1 ms
; 0000 00AB // Output Pulse(s):
; 0000 00AC // OC1B Period: 1 ms Width: 0.50006 us
...
; 0000 00B1 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (1<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(35)
	OUT  0x2F,R30
; 0000 00B2 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (1<<WGM13) | (1<<WGM12) | (0<<CS12) | (0<<CS11) | (1<<CS10);
	LDI  R30,LOW(25)
	OUT  0x2E,R30
...
; 0000 00B6 ICR1L=0x00;
	OUT  0x26,R30
; 0000 00B7 OCR1AH=0x1F;
	LDI  R30,LOW(31)
	OUT  0x2B,R30
; 0000 00B8 OCR1AL=0x3F;
	LDI  R30,LOW(63)
	OUT  0x2A,R30
; 0000 00B9 OCR1BH=0x00;
	LDI  R30,LOW(0)
	OUT  0x29,R30
; 0000 00BA OCR1BL=0x04;
	LDI  R30,LOW(4)
	OUT  0x28,R30
; 0000 00BB 
...
; 0000 00C1 // Timer Period: 1.024 ms
; 0000 00C2 ASSR=0<<AS2;
	LDI  R30,LOW(0)
	OUT  0x22,R30
; 0000 00C3 TCCR2=(1<<PWM2) | (0<<COM21) | (0<<COM20) | (1<<CTC2) | (0<<CS22) | (1<<CS21) | (1<<CS20);
	LDI  R30,LOW(75)
	OUT  0x25,R30
...
; 0000 00F1            kt_dw();
	RCALL _kt_dw
; 0000 00F2          }
; 0000 00F3       kt_start_stop();
_0x2D:
	RCALL _kt_start_stop
; 0000 00F4       value= captocdo*100;
	MOVW R30,R6
	LDI  R26,LOW(100)
	LDI  R27,HIGH(100)
	CALL __MULW12U
